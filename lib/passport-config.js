...
//       callbackURL : 'http://project-event-web.herokuapp.com/auth/facebook/callback',
...
//   }));
  ...
  passport.use(new KakaoStrategy({
      ...
      // clientSecret: process.env.KAKAOS_CLIENTSECRET,
      // clientID : '65a782a59f9c39605ada891145256dcd',
      // callbackURL: 'http://project-event-web.herokuapp.com/auth/kakao/callback'
      callbackURL: 'http://localhost:3000/auth/kakao/callback'
    },async (token, refreshToken, profile, done) => {
      console.log('Kakao', profile._json.kaccount_email); // profile 정보로 뭐가 넘어오나 보자.
      console.log('kakao email' , profile._json.properties.profile_image);
      try {
